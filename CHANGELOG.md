...
- build: bump @biomejs/biome to 2.5.12
- build: bump tsx to 4.23.13
- build: bump @earendil-works/pi-ai to 0.84.4
- build: bump @earendil-works/pi-coding-agent to 0.84.4
- build: bump github/codeql-action to 4.38.0
